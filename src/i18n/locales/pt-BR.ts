...
export const ptBR: Messages = {
  ...
  map: {
    ...
    places: {
      hobbiton: { name: 'Vila dos Hobbits' },
      buckland: { name: 'Terra dos Buques' },
      bree: { name: 'Bri' },
      weathertop: { name: 'Topo do Vento' },
      'last-bridge': { name: 'Última Ponte' },
      'ford-of-bruinen': { name: 'Vau do Bruinen' },
      caradhras: { name: 'Caradhras' },
      'dimrill-dale': { name: 'Vale do Riacho Escuro' },
      lothlorien: { name: 'Lothlórien' },
      fangorn: { name: 'Fangorn' },
      isengard: { name: 'Isengard' },
      edoras: { name: 'Edoras' },
      'helms-deep': { name: 'Abismo de Helm' },
      ...
      'dead-marshes': { name: 'Pântanos Mortos' },
      'black-gate': { name: 'Portão Negro' },
      'minas-morgul': { name: 'Minas Morgul' },
      'cirith-ungol': { name: 'Cirith Ungol' },
      'mount-doom': { name: 'Montanha da Perdição' },
  ...
  regionsPage: {
    meta: {
      title: 'Regiões da Terra-média',
      description: 'Seis terras, seis identidades: uma jornada editorial pelas regiões da Terra-média, do Condado a Mordor.',
    },
    skip: 'Pular para a primeira região',
    kicker: 'Terra-média / Regiões',
    titleA: 'Regiões',
    titleB: 'da Terra-média',
    lead: 'Seis terras. Seis identidades. Um mundo moldado pela distância, pela história e pela memória.',
    cue: 'Role para explorar',
    indexLabel: 'Regiões',
    goTo: 'Ir para {name}',
    progress: 'Região {current} de {total}',
    labels: {
    ...
    viewOnMapLabel: 'Ver {name} no mapa interativo',
    regions: {
      shire: {
        name: 'O Condado',
        short: 'Condado',
        tagline: 'Uma terra intocada pela grande ambição.',
        description: 'Colinas suaves, estradas tranquilas e uma vida definida pela simplicidade.',
        location: 'Oeste da Terra-média',
        terrain: 'Colinas suaves',
        identity: 'Paz',
        detailLabel: 'Povo',
        detail: 'Hobbits',
        alt: 'Amanhecer no Condado: colinas na névoa, um lago parado e uma porta verde e redonda numa encosta, além de uma cerca de madeira e uma trilha de terra.',
      },
      rivendell: {
        name: 'Valfenda',
        short: 'Valfenda',
        tagline: 'Um santuário entre montanhas.',
        description: 'Cachoeiras, pedra entalhada e uma quietude mais antiga que os reinos ao redor. O vale guarda seus conselhos.',
        location: 'Vale oculto',
        terrain: 'Cachoeiras e penhascos',
        identity: 'Refúgio',
        detailLabel: 'Povo',
        detail: 'Elfos',
        alt: 'Valfenda à primeira luz: salões élficos e uma ponte esguia sobre um desfiladeiro de cachoeiras, com montanhas nevadas ao fundo.',
      },
      moria: {
        name: 'Moria',
        short: 'Moria',
        tagline: 'Um reino sob as montanhas.',
        description: 'Salões escavados por um povo que amava a pedra. Agora só o silêncio os percorre.',
        location: 'Sob as Montanhas Sombrias',
        terrain: 'Pedra e profundeza',
        identity: 'Silêncio',
        detailLabel: 'Reino dos Anões',
        detail: 'Khazad-dûm',
        alt: 'Os salões de Moria: enormes pilares entalhados e uma ponte de pedra na escuridão, iluminados por um único feixe de luz vindo do alto.',
      },
      rohan: {
        name: 'Rohan',
        short: 'Rohan',
        tagline: 'Onde o horizonte nunca termina.',
        description: 'Capim até a beira do céu, e um povo que mede a distância pela velocidade de um cavalo.',
        location: 'A Marca dos Cavaleiros',
        terrain: 'Pradarias',
        identity: 'Vento e cavalos',
        detailLabel: 'Povo',
        detail: 'Rohirrim',
        alt: 'As planícies de Rohan ao pôr do sol: capim curvado pelo vento, um rio serpenteando pelo vale, cavalos pastando e um salão dourado sobre uma colina ao pé das montanhas.',
      },
      gondor: {
        name: 'Gondor',
        short: 'Gondor',
        tagline: 'A cidade branca sob as montanhas.',
        description: 'Pedra erguida em camadas contra a montanha. Um reino que se lembra de cada rei que já teve.',
        location: 'O Reino do Sul',
        terrain: 'Montanhas Brancas',
        identity: 'Legado',
        detailLabel: 'Sede',
        detail: 'Minas Tirith',
        alt: 'Minas Tirith, a cidade branca, erguendo-se em camadas contra a encosta, acima de um vale amplo e de um rio sinuoso.',
      },
      mordor: {
        name: 'Mordor',
        short: 'Mordor',
        tagline: 'Onde as sombras se deitam.',
        description: 'Uma planície de cinzas sob uma montanha que nunca esfria. Toda estrada, no fim, se curva em direção a este lugar.',
        location: 'A Terra da Sombra',
        terrain: 'Terra vulcânica',
        identity: 'Cinza e sombra',
        detailLabel: 'Marco',
        detail: 'Montanha da Perdição',
        alt: 'Mordor: uma planície de cinzas e lava sob a Montanha da Perdição em erupção, com a torre escura de Barad-dûr à direita.',
      },
    },
    closing: {
      kickerA: 'Seis regiões',
      kickerB: 'Uma Terra-média',
      line: 'O mundo continua além do horizonte.',
